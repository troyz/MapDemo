...
typedef enum BDSSynthesizerParamKey
{
     ...
     *
     * Effective only when using following interfaces:
     ...
     *
     * If using any of the following speak interfaces, this value is ignored and timeout is determined internally
     * by SDK.
...
/*
 * Use for setting minimum required connection type for using OnlineTTS.
 * Used with BDS_SYNTHESIZER_PARAM_ONLINE_TTS_THRESHOLD
 */
